...
// open een scherm waarin de fabriek te zien is
var dispLayout = false;
$("#layout_button").click(function() {
    $(this).toggleClass("selected"); // Button selected kleur geven

    if (!dispLayout) {
        // Scherm openen
        $("#layout_screen").addClass("right_active_layout");
        OpenRightSideBar(1250);
    } else {
        // Scherm sluiten
        CloseRightSidebar("#layout_div");
    }
